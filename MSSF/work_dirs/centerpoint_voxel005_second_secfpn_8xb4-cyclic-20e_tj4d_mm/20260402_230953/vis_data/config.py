...
launcher = 'none'
load_from = 'work_dirs/centerpoint_voxel005_second_secfpn_8xb4-cyclic-20e_tj4d_mm/epoch_10.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=20, type='EpochBasedTrainLoop', val_interval=20)
