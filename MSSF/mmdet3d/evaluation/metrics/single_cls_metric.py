...
from mmdet3d.evaluation.functional.kitti_utils.eval_vod_velo_3 import kitti_eval
...
class SingleCLSMetric(BaseMetric):
    ...
    def __init__(self,
        ...
        super(SingleCLSMetric, self).__init__(
    ...
    def kitti_evaluate(self,
        ...
        for name in results_dict:
            ...
            custom_methods = [0, 3, 1]
            eval_range_list = ['entire_area', 'roi', 'roi_out']
            result_str = ''
