...
from mmdet3d.evaluation.functional.kitti_utils.eval_tj4d import kitti_eval
...
class TJ4DMetric(BaseMetric):
    """TJ4D evaluation metric.
    ...
    def __init__(self,
        ...
        super(TJ4DMetric, self).__init__(
    ...
    def kitti_evaluate(self,
        ...
        for name in results_dict:
            ...
            if 'PR_detail_dict' in kwargs:
                ap_result_str, ap_dict_ = kitti_eval(
                    gt_annos, results_dict[name], classes, eval_types=eval_types, PR_detail_dict=kwargs['PR_detail_dict'])
            else:
                ap_result_str, ap_dict_ = kitti_eval(
