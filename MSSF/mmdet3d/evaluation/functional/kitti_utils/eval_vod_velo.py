...
def clean_data(gt_anno, dt_anno, current_class, difficulty, roi_clean=False):  # per frame
    ...
    valid_class_names = ['motion', 'static']
...
def kitti_eval(gt_annotations, dt_annotations, current_classes, eval_types=['bbox', 'bev', '3d'],pr_detail_dict=None, custom_method=0):
    ...
    overlap_0_7 = np.array([[0.5, 0.5],
                            [0.5, 0.5],
                            [0.5, 0.5]])
    overlap_0_5 = np.array([[0.3, 0.3],  # image
                            [0.3, 0.3],  # bev
                            [0.3, 0.3]])  # 3d
    ...
    result_str = "Results: \n" \
                    ...
                    +f"Motion: {ret_dict['motion_3d_all']} \n" \
                    +f"Static: {ret_dict['static_3d_all']} \n" \
                    +"\n" \
                    +f"Motion strict: {ret_dict['motion_3d_all_strict']} \n" \
                    +f"Static strict: {ret_dict['static_3d_all_strict']} \n" \
                    +"\n" \
                    +f"Motion R40: {ret_dict['motion_3d_all_r40']} \n" \
                    +f"Static R40: {ret_dict['static_3d_all_r40']} \n" \
                    +"\n" \
                    +f"Motion R40 strict: {ret_dict['motion_3d_all_r40_strict']} \n" \
                    +f"Static R40 strict: {ret_dict['static_3d_all_r40_strict']} \n" \
                    +"\n"
