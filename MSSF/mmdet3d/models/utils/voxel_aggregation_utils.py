...
def get_centroids_per_voxel_layer(points, feature_locations, multi_scale_3d_strides, voxel_size, point_cloud_range, keep_z=False):
    """ 获得voxel质心
    ...
    for feature_location in feature_locations[1:]:
        ...
        if keep_z:
            voxel_idxs[:, 2:] = torch.div(centroid_voxel_idxs_first[:, 2:], grid_scaling, rounding_mode='trunc')
        else:
