...
class VoxelNeXtFuseLatency(MVXTwoStageDetector):
    ...
    def init_weights(self):
        ...
        super(VoxelNeXtFuseLatency, self).init_weights()
    ...
    def extract_pts_feat(
        ...
        self.fusion_meter.update(self.pts_middle_encoder.fusion_meter.val)
        self.pts_feats_meter.update(self.pts_middle_encoder.pts_feats_meter.val+backbone_time+neck_time)
