...
model = dict(
    ...
    pts_bbox_head=dict(bbox_coder=dict(pc_range=point_cloud_range[:2], score_threshold=0.05)),
    pts_middle_encoder=dict(
        optional_cfg=dict(
            #init_query_order=('pos','voxel','img'),
            fusion_locations = ['x_conv1', 'x_conv2'],
            seg_cfg=dict(
    ...
    test_cfg=dict(pts=dict(pc_range=point_cloud_range[:2], score_threshold=0.05)))
