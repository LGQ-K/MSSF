...
randomness = dict(seed=277402400)
model = dict(
    data_preprocessor=dict(
        voxel_layer=dict(point_cloud_range=point_cloud_range)),
    pts_bbox_head=dict(bbox_coder=dict(pc_range=point_cloud_range[:2]), share_conv_channel=64),
    pts_middle_encoder=dict(
        encoder_channels=((32, 32), (64, 64), (127, 128), (256, 256), (256, 256), (256, 256)),
        optional_cfg=dict(apply_seg_scores_method='cat', norm_init_query=False, shared_conv_use_bias=False, use_query_to_seg=True)
        ),
