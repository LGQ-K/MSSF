...
model = dict(
    ...
    pts_middle_encoder=dict(optional_cfg=dict(use_seperate_radar_branch=True,use_seg_score_map=True, detach_score_map=True,query_voxel_fuse_method='channel_dynamic_add')),
