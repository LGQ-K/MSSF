...
model = dict(
    ...
    pts_middle_encoder=dict(
        type='SparseEncoderVoxelNeXt2DFuse',
        in_channels=7,
        voxel_layer=dict(
                x_conv1=dict(
                max_num_points=32,
                point_cloud_range=[0, -25.6, -3, 51.2, 25.6, 2],
                voxel_size=[0.08,0.08,0.125],
                max_voxels=(16000, 40000)
                ),
                x_conv2=dict(
                max_num_points=32,
        ...
        encoder_channels = [[64, 64, 64], [96, 96, 96, 96, 96], [128, 128, 128, 128, 128, 128, 128], [256, 256, 256, 256], [256, 256, 256, 256], [256, 256, 256, 256]],
        sparse_shape=[640, 640],
        output_channels=128,
        point_cloud_range=[0, -25.6, -3, 51.2, 25.6, 2],
        voxel_size=voxel_size,
        order=('conv', 'norm', 'act'),
