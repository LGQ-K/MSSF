...
class FastRunner:
    ...
    def __init__(
        ...
        if cfg.get('use_visualizer', False):
        ...
        default_hooks: dict
        default_hooks.pop('logger')
        default_hooks.pop('visualization')
        default_hooks.pop('runtime_info')
        default_hooks.pop('timer')
        default_hooks.pop('checkpoint')
    ...
    @classmethod
    def from_cfg(cls, cfg: ConfigType) -> 'FastRunner':
