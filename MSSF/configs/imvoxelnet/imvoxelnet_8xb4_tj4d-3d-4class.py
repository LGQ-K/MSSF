...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[
                [-0.16, -39.68, -1.163, 68.96, 39.68, -1.163],
                [-0.16, -39.68, -1.353, 68.96, 39.68, -1.353],
                [-0.16, -39.68, -1.363, 68.96, 39.68, -1.363],
                [-0.16, -39.68, -1.403, 68.96, 39.68, -1.403]
            ],
    ...
    prior_generator=dict(
        type='AlignedAnchor3DRangeGenerator',
        ranges=[[-0.16, -39.68, -3, 68.96, 39.68, 2.76]],
        rotations=[.0]),
    train_cfg=dict(
        assigner=dict(
...
train_pipeline = [
    ...
    dict(
        type='RandomResize', scale=[(1227, 913), (1450, 1079)],
        keep_ratio=True),
