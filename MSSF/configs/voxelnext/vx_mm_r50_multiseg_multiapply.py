...
model = dict(
    ...
    pts_middle_encoder=dict(
        optional_cfg=dict(
            seg_cfg=dict(
                    seg_method='seperate_seg',
                    seg_locations=['x_conv1', 'x_conv2', 'x_conv3'],
                    combine_method='nothing',
                    seg_sup_locations=['x_conv1', 'x_conv2', 'x_conv3'],
                    seg_apply_location=['x_conv1', 'x_conv2', 'x_conv3']
                )
        )),
