_base_ = [
    ...
    '../_base_/models/voxelnext_voxel005_vod_multimodal_r50pytorch_tj4d.py',
...
model = dict(
    ...
    pts_bbox_head=dict(bbox_coder=dict(pc_range=point_cloud_range[:2], score_threshold=0.02)),
    pts_middle_encoder=dict(optional_cfg=dict(use_seperate_radar_branch=True,use_seg_score_map=True, detach_score_map=True, score_map_bev_reduce_method='maxpool')),
    # model training and testing settings
    train_cfg=dict(pts=dict(point_cloud_range=point_cloud_range)),
    test_cfg=dict(pts=dict(pc_range=point_cloud_range[:2], score_threshold=0.02)))#nms_thr=0.1)))
...
randomness=dict(seed=333411669)