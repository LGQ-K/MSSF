...
model = dict(
    ...
    pts_bbox_head=dict(bbox_coder=dict(pc_range=point_cloud_range[:2], score_threshold=0.1)),
    ...
    test_cfg=dict(pts=dict(pc_range=point_cloud_range[:2], score_threshold=0.1)))
