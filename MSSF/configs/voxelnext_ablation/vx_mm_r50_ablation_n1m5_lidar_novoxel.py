_base_ = [
    '../_base_/datasets/vod-3d-3class_lidar.py',
    '../_base_/models/voxelnext_voxel005_vod_multimodal_r50pytorch_lidar.py',
...
model = dict(
    ...
    pts_middle_encoder=dict(
        optional_cfg=dict(
            #init_query_order=('pos','voxel','img'),
            query_init_feat_src = ['img'],
            query_voxel_fuse_method = 'nothing',
            fusion_locations = ['x_conv1'],
            seg_cfg=dict(
                    seg_method='final_seg',
                    seg_locations=['x_conv1'],
                    feature_src=['x_conv1'],
                    seg_sup_locations=['x_conv1'],
                    seg_apply_location='x_conv1'
                )
        )),
